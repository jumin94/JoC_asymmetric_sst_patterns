...
def plot_one_sst(sst,mod_name,year,lons,lats,box,levels=np.arange(-2,2,0.1),cmap = 'RdBu_r'):
    ...
    ax1.set_title(split_title_line(r'ONDJF SST  - year: '+str(year)+'model: '+str(mod_name), max_words=5),fontsize=14)
